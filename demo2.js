 ...
 */
{
    class TextFX {
        constructor(el) {
            ...
            this.loopInterval = {show: 10, hide: 10};//This is where to contro text animation speed
    ...
    class Slide {
        ...
        toggleImage(action, dir) {
            ...
            .to(this.DOM.img.wrap, action === 'hide' ? 0.5 : 0.5,/*This is where to change spees of image*/ {
